                        ...
                        <tr>
						 ...
						 <td class="align-middle"><c:choose>
							<c:when test="${not empty student.photoPath}">
								<img style="width: 50px; height: 50px;" class="image"
									src="${pageContext.request.contextPath}/image/${student.photoPath}"
									alt="Student Photo">
							</c:when>
							<c:otherwise>
								<img class="image"
									src="${pageContext.request.contextPath}/image/thumbnail-default.jpg"
									alt="Default Thumbnail">
							</c:otherwise>
							</c:choose>
						</td>
                          <td><button type="button" class="btn btn-info  " onclick="location.href = '/studentRegistrationSystem-mvc-jpa/updateStudent/${studentId}';">
	                        Update
	                    </button>
